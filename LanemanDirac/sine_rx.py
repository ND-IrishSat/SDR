...
class sine_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Sine Rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sine Rx")
        ...
        self.tab0.addTab(self.tab0_widget_1, 'Frequency')
        ...
        self.tab0.addTab(self.tab0_widget_2, 'XY')
        ...
        self._freq_range = Range(480e6, 490e6, 0.05, 483e6, 200)
